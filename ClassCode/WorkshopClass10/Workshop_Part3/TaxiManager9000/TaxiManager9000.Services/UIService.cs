...
namespace TaxiManager9000.Services
{
    public class UIService : IUIService
    {
        ...
        {
            Console.WriteLine("TaxiManager9000!");
        ...
        public int MainMenu(Role role)
        {
            ...
            MenuItems = menuItems;
            return ChoseMenu(MenuItems);
        }

        public int ChoseMenu<T>(List<T> items)
        {
            Console.Clear();
            if(items.Count == 0)
            {
        ...
        public int ChoseEntitiesMeny<T>(List<T> entities) where T : BaseEntity
        {
            Console.Clear();
            if (entities.Count == 0)
            {
        ...
        UserService IUIService.LogInMenu()
        {
            throw new NotImplementedException();
        }
    }
